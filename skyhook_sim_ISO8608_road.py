...
def main():
    ...
    ax1.plot(t, road(t) * 1000, label="road", color="gray", linestyle="--")
...
def solve_freq(pos, t):
    ...
    try:
        ...
        return 0 # In this case, the body does not cross zero more than once, so it has no frequency
